...
class Logger {
     ...
     * Cumple con el principio de no repudio del Track 1: si falla el
     * registro, propagamos la excepción para que el controlador haga
     * rollback de la transacción y no quede una acción sin auditoría.
     *
